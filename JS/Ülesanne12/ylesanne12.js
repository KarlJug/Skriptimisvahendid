...
class Ostukorv extends Ladu {
    ...
    get Ostukorv() {
        ...
        this.tooted.forEach(toode => {
            const ostukorvListID = document.getElementById("ostukortv");
            ostukorvListID.innerHTML += "<li>" + toode.nimi + "\t" + toode.hind + "€\t" + toode.kogus + "tk</li>";
        });
    }
    ...
    get summaKokku() {
        ...
        const ostukorvListID = document.getElementById("ostukortv");
        const uusSumma = document.createElement('p');
        uusSumma.textContent = "Summa kokku: " + summa + "€";
        ostukorvListID.appendChild(uusSumma);
    }
}
